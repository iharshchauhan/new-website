...
function buildSiteChrome() {
  ...
  const contact = `${basePath}/contact/`;
  ...
  <footer class="site-footer">
    ...
    <div class="site-footer__meta">
      ...
      <span class="site-footer__line">|</span>
      <a href="${contact}" class="site-footer__accent">Contact</a>
      <span class="site-footer__line">|</span>
      <span>This page visit emitted <span class="site-footer__accent">0.04g of CO2</span> :)</span>
    </div>
  </footer>`,
  };
}
