...
export function Footer() {
  return (
    <footer className="w-full max-w-4xl mx-auto py-12 px-6 md:px-12 text-sm text-muted-foreground flex flex-col items-center space-y-8">
      <div className="w-full flex justify-center overflow-hidden text-primary/70 text-[10px] tracking-[0.5em] opacity-80">
      ...
      <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-4 text-center text-muted-foreground">
        ...
        <Link
          href="/contact"
          className="hover:text-foreground transition-colors border-b-2 border-primary/70 pb-0.5"
        >
          Contact
        </Link>
        <span className="hidden sm:inline opacity-50">|</span>
